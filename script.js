...
function initEmailJS() {
    ...
    emailjs.init("IQujbyKGZzEAZUJko"); // Replace with your EmailJS public key
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            const templateParams = {
                ...
                to_name: 'Mann Mehta', // Replace with your name
            };

            // Send the email using EmailJS
            emailjs.send('service_ypjbvke', 'template_fw3r6ip', templateParams)
